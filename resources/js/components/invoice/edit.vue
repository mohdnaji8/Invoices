...
const deleteInvoiceItem = (id, i) => {
    ...
    if (id != undefined) {
        axios.get('/api/delet_invoice_item/'+id)
    }
}
...
const onEdit = (id) => {
    if (form.value.invoice_items.length >= 1){
       // alert(JSON.stringify(form.value.invoice_items))
        ...
        formData.append('refrence', form.value.refrence)
            ...
            <div class="card__content">
                <div class="card__content--header">
                    ...
                    <div>
                        ...
                        <input type="text" class="input" v-model="form.refrence">
                    </div>
                </div>
                <br><br>
                <div class="table">
                    ...
                    <div class="table--items2" v-for="(itemcart,i) in form.invoice_items">
                        <p v-if="itemcart.product">
                            #{{ itemcart.product.item_code }} {{itemcart.product.description}} </p>
                        <p v-else>
            ...
            <div class="modal__content">
                ...
                <div class="modal__items">
                    <ul style="list-style: none">
                        <li v-for="(item, i) in listProducts" :key="item.id" style="display:grid; grid-template-columns: 20px 350px 15px; align-items: center; padding-bottom: 5px">
                            <p > {{i+1}}</p>
                ...
                <div class="model__footer">
                    ...
                    <button class="btn btn-light btn__close--modal " @click="addCart()">Save</button>
                </div>
            </div>
        </div>
